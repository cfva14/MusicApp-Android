            ...
            if (itemToOpenWhenDrawerCloses >= 0) {
                ...
                if (activityClass != null) {
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
                        val extras = ActivityOptions.makeCustomAnimation(this@BaseActivity, R.anim.fade_in, R.anim.fade_out).toBundle()
                        startActivity(Intent(this@BaseActivity, activityClass), extras)
                    } else {
                        startActivity(Intent(this@BaseActivity, activityClass))
                    }
                }
            }
        }
